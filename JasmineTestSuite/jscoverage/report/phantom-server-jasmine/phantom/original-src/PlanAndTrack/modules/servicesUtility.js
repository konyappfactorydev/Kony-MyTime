var utilities = Class({
    ...
    beautifyPhoneNumber: function(phoneNumber) { //formatting the phone number
        try {
            ...
            kony.appfoundation.log.error("error in Blogic beautifyPhoneNumber : " + err);
        }
    },
    ...
    configureSubMenu: function(viewModel, scrollId, widgets, submenu) {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic configureSubmenu : " + err);
        }
    ...
    getPriorityImageKA: function(priorityValue) {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get priorityImage : " + err);
        }
    },
    ...
    getStatusImageKA: function(statusValue) { //getting status image
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get getStatusImage : " + err);
        }
    },
    getpriorityMapPinImageKA: function(priorityValue, viewType) {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get priorityMapPinImage : " + err);
        }
    },
    getstatusMapPinImageKA: function(statusValue) {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get statusMapPinImage : " + err);
        }
    },
    getstatusMapPinImageFocusKA: function(statusValue) {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get getstatusMapPinImageFocusKA : " + err);
        }
    },
    getStatusKA: function(statusValue) { //getting status image
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get getStatusKA : " + err);
        }
    },
    getPriorityOrTodayMapPinImageFocusKA: function() {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get getPriorityOrTodayMapPinImageFocusKA : " + err);
        }
    },
    geti18nValueKA: function(key) {
        try {
            ...
            kony.appfoundation.log.error("error in Blogic get geti18nValueKA : " + err);
        }
    },
    getWorkingDayListKA: function() { //getting working days list
        try {
            ...
            kony.appfoundation.log.error("error in Blogic getWorkingDayListKA : " + err);
        }
    },
    ...
    dataTruncation: function(value, num_char, num_char_trunc, appendingstring) { //Data Truncation     
        try {
            ...
            kony.appfoundation.log.error(" " + err);
        }
    },

    navigationOnGesture: function(myWidget, gestureInfo) {
        try {
            var INSTANCE = kony.appfoundation.v2.SaaSApplication.INSTANCE;
    ...
    convertDataToGroup: function(data, header_fields) { //Grouping of data with headers on it
        try {
            ...
            for (var k = 0; k < dataOutput.length; k++) {
                ...
                var lclHeaderValue = dataOutput[k][0][header_fields[0]] + " (" + dataOutput[k][1].length + ")";
                var headerValue = {
            ...
            kony.appfoundation.log.error("error in Blogic  convertDataToGroup : " + err);
        }
    },
    ...
    getOrderAddress: function(address) { //Getting Address for Order List
        try {
            var finalAddress = "";
            if (address) {
                finalAddress += address["Address1"] ? (address["Address1"].trim() ? (address["Address1"] + ", ") : "") : "";
                finalAddress += address["Address2"] ? (address["Address2"].trim() ? (address["Address2"] + ", ") : "") : "";
                finalAddress += address["Address2"] ? (address["Address2"].trim() ? (address["Address3"] + ", ") : "") : "";
            ...
            kony.appfoundation.log.error("error in Blogic  getOrderAddress : " + err);
        }
    },
    ...
    getStatusHeaderImageKA: function(statusValue) { //Getting Status Header Image
        try {
            ...
            kony.appfoundation.log.error("error in Blogic  getStatusImage : " + err);
        }
    },
 	...
 	try{
		if(!isMenuShown){
			...
			if(menuFlexRef){
				...
				formName.flexMainKA.animate(getAnimationObject(),animConfig(),{animationStart:function(){},animationEnd:endCallBack});
			}
			
			function getAnimationObject(){
				var animDefinition = {"100" :{ "left":"80%"}};
			...
			formName.flexMainKA.animate(getAnimationOutObject(),animConfigOut(),{animationStart:function(){},animationEnd:endCallBackKA});

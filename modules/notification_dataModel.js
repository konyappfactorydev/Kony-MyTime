...
// ****************Generated On Mon Oct 30 11:50:34 UTC 2017notification_data*******************
...
com.kony.MYTIME.notification_data.remove = function(wcs, successcallback,errorcallback, markForUpload){
	...
	var targetAttributes = [];
 		...
 		targetAttributes.push("notification_id");
		//srcAttributes and targetAttributes are interchanged while calling the removecascade
		if(!kony.sync.removeCascadeHelper(tx, targetAttributes, srcAttributes, tbname, wcs, com.kony.MYTIME.notification.removeCascade,"notification",false, errorcallback, markForUpload, null, false)){
			isError = true;	
			kony.sync.rollbackTransaction(tx);
			return;
		}

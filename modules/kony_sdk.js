    ...
    function processServiceDocMap(servConfig) {
        ...
        try {
            ...
            if (kony.sdk.getSdkType() !== kony.sdk.constants.SDK_TYPE_PLAIN_JS
                && kony.sdk.getSdkType() !== kony.sdk.constants.SDK_TYPE_PHONEGAP) {
	...
	this.login = function(options, successCallback, failureCallback) {
		...
		function performOauthOrSamlLogin(authOptions) {
			...
			if (authOptions.hasOwnProperty("userid") && authOptions.hasOwnProperty("password")) {
				...
				if(kony.sdk.isSSOLoginSuccess && kony.sdk.sso.isSSOEnabled == true
					&& !kony.sdk.util.isNullOrEmptyString(kony.sdk.util.getSSOToken())) {
					...
					if (kony.sdk.getSdkType() === kony.sdk.constants.SDK_TYPE_PLAIN_JS) {
						if (authOptions[kony.sdk.constants.DEEPLINK_VALID_PARAM] && authOptions["urlType"]){
...
kony.logger = {
    ...
    createLoggerConfig: function() {
        ...
        var persistorList = [];
        logFilterC.logLevel = kony.logger.logLevel.NONE;
...
/*
*JSBindings for KonyWebSocket
*/
kony.sdk.KonyWebSocketClasses = (function () {
    var instance = null;
    var LOG_PREFIX = "kony.WebSocket";
    ...
    return {
        import: function () {
            kony.sdk.logsdk.trace(LOG_PREFIX + ": Importing native KonyWebSocket");
            if (instance === null) {
                instance = createInstance();
            }
            return instance;
...
kony.sdk.binary.getBinaryData = function (inputParams, streaming, downloadConfig,
    ...
    if (parsedTemplate[kony.sdk.binary.constants.HTTP_STATUS_CODE] == kony.sdk.binary.constants.VALID_HTTP_REDIRECT_CODE) {
        ...
        options[kony.sdk.constants.IGNORE_MESSAGE_INTEGRITY] = true;
        var networkProvider = new konyNetworkProvider();
        networkProvider.get(requestParams[kony.sdk.binary.constants.URL], null,
            requestParams[kony.sdk.binary.constants.HEADERS],
            function (blobObject) {
                var successObject = {};
    ...
    function templateFetchSuccess(uploadConfig) {
        ...
        if (parsedTemplate[kony.sdk.binary.constants.HTTP_STATUS_CODE] == kony.sdk.binary.constants.VALID_HTTP_REDIRECT_CODE) {
            ...
            if (parsedTemplate[kony.sdk.binary.constants.UPLOAD_MODE].toLowerCase() === kony.sdk.binary.constants.UPLOAD_MODE_BINARY) {
                ...
                var formData = new kony.net.FormData({isMultiPart:true});
            ...
            if(requestParams[kony.sdk.binary.constants.METHOD].toLocaleUpperCase() === kony.sdk.binary.constants.HTTP_METHOD_POST) {
                networkProvider.post(requestParams[kony.sdk.binary.constants.URL],
                    requestBody,
                    requestParams[kony.sdk.binary.constants.HEADERS],
                    ...
                    parsedTemplate[kony.sdk.binary.constants.UPLOAD_MODE].toLowerCase(),
                    options);
            }
        } else {
            //TODO: Handle http status which is not 309
...
/*
JS Bindings to Kony WebSocket native classes
*/
kony.sdk.KonyWebSocketClasses = (function () {
    var instance = null;
    var LOG_PREFIX = "kony.WebSocket";
    ...
    function createInstance() {
        kony.sdk.logsdk.trace(LOG_PREFIX + ": Creating instance of KonyWebSocketClasses");
        var obj = {};
        obj.KonyWebSocket = objc.import("KonyWebSocket");
        return obj;
    }
...
function OAuthHandler(serviceUrl, providerName, appkey, callback, type, options, isMFVersionCompatible) {
	...
	if (typeof(XMLHttpRequest) !== 'undefined') {
		...
		var _listener = function (event) {
		    ...
		    if(!kony.sdk.util.isValidString(eventOrigin) || (serviceUrl.indexOf(eventOrigin) < 0)) {
		        return;
		    }
...
kony.invokeEASMetaServiceWithLiteInit = function (appCredentials, versionCheckOptions, versionCheckSuccessCallback, versionCheckFailureCallback) {
    ...
    function _fetch(serviceObj, objectName, options, tmpDataUrl, successCallback, serviceErrorCallback) {
        ...
        invokeObjectOperation(url, objectName, headers, null,
            kony.sdk.constants.HTTP_METHOD_GET,
            function (response) {
                kony.sdk.verifyAndCallClosure(successCallback, response);
            },
            function (error) {
...
function konyNetHttpRequest(url, params, headers, httpMethod, konyContentType, successCallback, failureCallback, options) {
    ...
    function localRequestCallback(result) {
        ...
        if (readyState === 4) {
            ...
            if(responseHeaders && responseHeaders.hasOwnProperty(kony.sdk.constants.PASSTHROUGH_RESPONSE_HEADER)
                                                                        && (kony.sdk.convertPassthroughResponseToJson !== true)) {
            ...
            if(isInvalidResponse || (!response &&  status >= 200 && status < 300)){
                ...
                if (response.opstatus == 0 || (response.opstatus >= 500100 && response.opstatus <= 500200)) {
                    ...
                    } else if(options && (options[kony.sdk.constants.DISABLE_INTEGRITY] || options[kony.sdk.constants.PASSTHROUGH]
                                          || options[kony.sdk.constants.IGNORE_MESSAGE_INTEGRITY])){
                        successCallback(response);
                    } else {
                        validateIntegrityAndHandleCallbackInvocation(response);
                    }

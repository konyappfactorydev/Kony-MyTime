...
kony.sdk.mvvm.frmAuditTrailControllerExtension = Class(kony.sdk.mvvm.BaseFormControllerExtension, {
    ...
    fetchData: function() {
        try {
            var scopeObj = this;
            //quering audit data.
            var query = "select ta.*, emp.First_Name as First_Name from Timesheet_Audit ta left join Employee emp on ta.employee_id = emp.Id where ta.Timesheet_Id = '" + kony.apps.coe.ess.myTime.ViewTimeSheet.timeSheetId + "';";
        ...
        function successCallbackForAuditRecords(res) {
            ...
            kony.apps.coe.ess.MVVM.executeDBQuery("MYTIME", query, successCallbackForComments.bind(scopeObj, res), error);
        }
        ...
        function successCallbackForComments(data, res) {
            ...
            kony.apps.coe.ess.MVVM.executeDBQuery("MYTIME", query, successCallbackForPendingTimesheet.bind(scopeObj, data), error);
        }

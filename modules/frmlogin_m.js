...
kony.apps.coe.ess.frmLogin.btnLoginOnclick =
  function() {
  kony.print("perflogs time:  The time when login button is clicked is .......");
  try {
...
/**
  ...
  try {
    try {
      ...
      KNYMetricsService.sendCustomMetrics("frmLogin", metricsData);
    } catch (m) {
...
kony.apps.coe.ess.frmLogin.onLogout = function() {
  ...
  var alert = kony.ui.Alert({
    ...
    "alertTitle": kony.i18n.getLocalizedString("i18n.ess.Login.LogoutMessage"),
    "yesLabel": kony.i18n.getLocalizedString("i18n.myPay.BankAccount.yes.text"),
    "noLabel": kony.i18n.getLocalizedString("i18n.myPay.BankAccount.no.text"),
    "alertIcon": "",
...
//     var previousUsername = storedUsername; //ToDo : Remove this line after security functions added
...
kony.apps.coe.ess.frmLogin.offlinePopup = function() {
  ...
  kony.print("--value "+kony.apps.coe.ess.syncFunctions.syncHamburger);

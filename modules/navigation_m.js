    ...
    frmTimeSheetCreate.btnDone.onClick = function() {
        try {
          ...
          if (!kony.apps.coe.ess.myTime.TimesheetCreate.Backend.CurrentTaskTimelineData.isValidData() && !kony.apps.coe.ess.myTime.TimesheetCreate.Backend.CurrentTaskTimelineData.isTaskSelected()) {
                ...
                if(kony.apps.coe.ess.myTime.TimesheetCreate.WorkLeaveToggle.isWork===true){
            	handleCustomAlert("Please Select Task & Time Type");
                }
                else{
                  handleCustomAlert("Please Select Leave Type");
                }
            	return;
            }
          if (!kony.apps.coe.ess.myTime.TimesheetCreate.Backend.CurrentTaskTimelineData.isTaskSelected() && kony.apps.coe.ess.myTime.TimesheetCreate.WorkLeaveToggle.isWork===true) {
